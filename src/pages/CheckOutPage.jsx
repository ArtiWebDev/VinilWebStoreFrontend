  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: 'Your order placed in DB successfully!',
        icon: 'success',
              ...
              >
                <div className="text-slate-800">
                    ...
                    <div className="flow-root">
                      <ul role="list" className=" divide-y divide-gray-200">
                        {cartItems.map((product) => (
                          <li
                            key={product?._id}
                            className="flex flex-row items-center justify-between py-2 gap-3"
                          >
                            ...
                            <p className="sm:ml-4 font-roboto text-sm">
                  ...
                  <div className="mt-2">
                    ...
                    <p className="text-slate-700 font-medium font-roboto mb-6">
                      {/* Qty: {cartItems.length > 0 ? cartItems.length : 0} */}
                      Quantity: {cartItems.length > 0 ? cartItems.length : 0}
                    </p>
                  </div>
                </div>
                <div className="lg:col-span-2">
                  <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                    <div className="md:col-span-5">
                      <p className="text-slate-800 text-2xl font-bold mb-1">
                        Personal Details
                      </p>
                      <p className="mb-2">All fields are required to fill</p>
                      <label
                        htmlFor="full_name"
